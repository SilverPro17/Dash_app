...
markdown_intro = """\
# Análise Estatística e Modelação Preditiva - Dataset de Plâncton
...
markdown_eda_ml = """\
## 2. Análise Exploratória para Modelação
...
code_eda_ml = """\
# Distribuição da variável alvo (individualCount)
...
code_unsupervised = """\
# Preparar dados para análise não supervisionada
